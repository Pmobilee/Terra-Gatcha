# Dome Exploration Run 09 - full_collection

- Timestamp: 2026-03-07T12:06:22.514Z
...
- [0] ⚙ | tag=button | disabled=false | rect=1188,0,44x44
- [1] DEV | tag=button | disabled=false | rect=1232,4,44x44
- [2] Keyboard Shortcuts | tag=summary | disabled=false | rect=888,219,365x28

## Tested Elements
- [0] ⚙ => FAIL | screen base -> base | TimeoutError: locator.click: Timeout 1200ms exceeded.
- [1] DEV => OK | screen settings -> settings
- [2] Keyboard Shortcuts => FAIL | screen settings -> settings | TimeoutError: locator.click: Timeout 1200ms exceeded.
