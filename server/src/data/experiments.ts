/**
 * A/B experiment definitions — server-side copy (Phase 41.2).
 * Duplicated from src/data/experiments.ts to avoid cross-boundary import issues
 * between the Vite client build and the Node ESM server build.
